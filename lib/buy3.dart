...
import 'sellbuy.dart'; // Import sellbuy1 for navigation
import 'buy2.dart';
import 'sellbuy1.dart';
import 'package:fyp/select.dart';

//import 'sellbuy1.dart';
class buy3 extends StatefulWidget {
  @override
  _buy3State createState() => _buy3State();
}

class _buy3State extends State<buy3> {
  int currentPage = 3;
  int totalPages = 3;
  ...
  void _navigateToPage(int page) {
    if (page == 1) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => buy2()),
      );
    } else if (page == 3) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => buy3()),
      );
    } else {
      setState(() {
        currentPage = page;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: const Color.fromARGB(255, 88, 169, 180),
        ...
        ConstrainedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => sellbuy1()),
              );
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: Color.fromARGB(255, 88, 169, 180),
