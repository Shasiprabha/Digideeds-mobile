...
import 'package:fyp/buy2.dart';
import 'package:fyp/sellbuy1.dart';
import 'package:fyp/buy3.dart';
  ...
  void _navigateToPage(int page) {
    if (page == 1) {
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => sellbuy()), // Navigate to Page 1
      );
    } else if (page == 2) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => buy2()), // Navigate to Page 2
      );
    } else if (page == 3) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => buy3()), // Navigate to Page 3
      );
    } else {
      setState(() {
        currentPage = page;
        ...
        ConstrainedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Color.fromARGB(255, 3, 66, 75), // New text color
              ),
            ),
          ),
        ),
