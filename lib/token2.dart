...
import 'selltoken.dart'; // Import sellbuy1 for navigation
import 'token3.dart';
import 'selltoken1.dart';
import 'select.dart';

//import 'sellbuy1.dart';
class token2 extends StatefulWidget {
  @override
  _token2State createState() => _token2State();
}

class _token2State extends State<token2> {
  int currentPage = 2;
  int totalPages = 3;
  ...
  void _navigateToPage(int page) {
    if (page == 1) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => token2()),
      );
    } else if (page == 3) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => token3()),
      );
    } else {
      setState(() {
        currentPage = page;
